...
const TermsAndRules = () => {
  return (
    <div>
                ...
                <p>This Service is only available to users who are at least 14 years old. If you are younger than this, please do not register for this Service. If you register for this Service, you represent that you are this age or older.</p>
                ...
                <p>If you do not agree with these terms, please do not register or use the Service. Use of the Service constitutes acceptance of these terms. If you wish to close your account, please <a href="https://mail.google.com/mail/?view=cm&source=mailto&to=vnthread.fun@gmail.com">contact us</a>.</p>
			</div>
