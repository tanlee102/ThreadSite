...
const GroupLatestPost = ({darkMode,data}) => {
  ...
  return (
    ...
    <div class="item-hub remove-9th-item" dark-mode={String(darkMode)}>

        {data.map((item, index) => (

            <div key={index} className='item-tab_'>
                <div class="item-tab fill-item-tab set-border-box-1">
                    ...
                    <div class="content-item-tab">
                        ...
                        <div class="extra-item-tab set-two-line-overflow">
                            {item.SubForumName}
                        </div>
                        </Link>
...
export default GroupLatestPost
