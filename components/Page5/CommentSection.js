...
const CommentSection = ({addMsgBtn, datas, deleteMsgBtn, deleteReMsgBtn, addReMsgBtn, loadReMsgsBtn, userData, allowed, isYourProfile}) => {
...
<> 
    ...
    <div style={{display: userData.logged ? "flex" : "none"}} class="item-input-comment">
        ...
        <span>
            <textarea onKeyDown={handleKeyDown} name=""  placeholder="Viết bình luận..." id="wall-comment-input" rows="1"></textarea>
