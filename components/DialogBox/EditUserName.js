        ...
        setTimeout(() => {
            updateUserName({
              ...
              if(code == 1){
                ...
                Cookies.set('user_package', JSON.stringify(user_package), { expires: 30});
  ...
  return (
    <div  class={isDisplay ? "dialog-confirm active-confirm" : "dialog-confirm"}>
        ...
        <div>
            <div>
                <header> 
                    <h3> Chỉnh sửa tên người dùng </h3> 
                    <i class="fa fa-close" aria-hidden="true" onClick={() => setIsDisplay(false)}></i>
                </header>

                <div class="dialog-msg dialog-user-name"> 

                    <input value={textIn} onChange={handleChange} id='input-dialog-user-name' type="text" maxLength={env_variable.MAX_NAME_USER_LENGTH}
