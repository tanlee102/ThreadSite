...
const PollItems = ({data,isShowEmpty = true, darkMode}) => {
  return (
  
          <div className='item-hub' dark-mode={String(darkMode)}>

            {data?.length == 0 && isShowEmpty == true ? 
                <div className='empty-panel'>
                    <div>
                        <svg viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M20.625 1.625C20.2108 1.625 19.875 1.96079 19.875 2.375V22.375C19.875 22.7892 20.2108 23.125 20.625 23.125C21.0392 23.125 21.375 22.7892 21.375 22.375V2.375C21.375 1.96079 21.0392 1.625 20.625 1.625Z"/>
            ...
            {data?.length > 0 ?
              data.map((item, index) =>
              <Link key={index} href={"/polling/"+item.poll_id+"/"}>
                  <div className='item-tab_ cursor-pointer'>
                    <div className='item-tab fill-item-tab set-border-box-1'>
                      <div class="title-item-poll">
                            <span><svg  viewBox="-32 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M448 432V80c0-26.5-21.5-48-48-48H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48zM112 192c-8.84 0-16-7.16-16-16v-32c0-8.84 7.16-16 16-16h128c8.84 0 16 7.16 16 16v32c0 8.84-7.16 16-16 16H112zm0 96c-8.84 0-16-7.16-16-16v-32c0-8.84 7.16-16 16-16h224c8.84 0 16 7.16 16 16v32c0 8.84-7.16 16-16 16H112zm0 96c-8.84 0-16-7.16-16-16v-32c0-8.84 7.16-16 16-16h64c8.84 0 16 7.16 16 16v32c0 8.84-7.16 16-16 16h-64z"/></svg></span>
                            <span className="set-two-line-overflow">{item.title}</span>
                        <div class="list-in-line"><ul><li>{item.name}</li><li class="set-anchor-gray-color">{item.total_votes} bình chọn</li></ul></div>
                      </div>
                    </div>
                  </div>
                </Link>
