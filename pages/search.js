...
import { loadListSearchThread, loadListSearchMember, loadListSearchSubForum } from '../data/fetch';
...
const Search = ({listthread, listmember, listsubforum}) => {
  ...
  return (
    <>
    <Meta title={"Tìm kiếm | AniVnThread"}></Meta>
...
export async function getServerSideProps(context) {
  ...
  return {
    props: {
      listthread, listmember, listsubforum, dark_mode
    }
  }
}
