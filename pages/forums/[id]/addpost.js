...
const Addpost = ({tagthread, infoaddpost}) => {
  ...
  return (
    ...
    <Meta title={"Thêm bài viết | AniVnThread"}>
        {typeKit ? <>
    ...
    <div class="fr-create-post">
      ...
      <div class="submit-reply-sheet-item">
          ...
          <span onClick={() => {previewFunc(typeKit ?  String(document.getElementById('editable').innerHTML) :  nokitConvert(dataNoKit, true), addPostBtn, Number(document.getElementsByClassName("chose-tag-post").item(0).value) === 1)}}>
