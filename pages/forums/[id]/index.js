...
import { loadThreadHead, loadThreadOther, loadToken } from '../../../data/fetch'
import { updatePinThread, deleteThread, saveSubForum, checkToken} from '../../../data/axios_fetch'
...
const Forums = ({threadOthers, threadHead}) => {
  ...
  return (
    <>
    <div>
      <Meta title={threadHead.title + " | AniVnThread"}>
